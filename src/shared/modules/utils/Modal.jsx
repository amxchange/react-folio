...
import { SlipAwayListener } from "@shared/modules/utils";
...
class Modal extends React.Component {
    ...
    render() {
        ...
        let { containerStyles, containerClass, closeOnClickAway, hideClose } = this.props;
        ...
        return (
            ...
            >
                <SlipAwayListener
                    onClickAway={() => {
                        closeOnClickAway && this.hide({ reject: true })
                    }}
                    renderOwnChildren={wrapperRef => (
                        <div
                            ref={wrapperRef}
                            className={`dialog-container ${containerClass || ""}`}
